...
const dayModal = (
 <div style = {{display:'block'}} className="w3-modal">
    <div className="w3-modal-content w3-border w3-border-red w3-animate-zoom w3-padding w3-ul w3-card-4">
           <li className = 'w3-large'><span onClick = {toogleModal} className = 'w3-border w3-button w3-display-topright'>X</span>Select Day</li>
...
<> 
     ...
     <div onClick = {toogleModal} style = {{height:'50px',width:'100%'}}></div>
 </>
  );
}
else if(day===2)
