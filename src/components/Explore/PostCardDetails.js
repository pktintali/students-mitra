...
alert('opened')
  ...
  return (
  <>
         <div className='w3-panel w3-card w3-padding w3-pale-blue'>
              <div>
                <img className = 'w3-left'style = {{borderRadius:'50%',width:'10%'}} src = 'https://pktintali.github.io/tdevelopersindia/images/logomain.jpg'/>
              ...
              <div className = 'w3-text-grey w3-margin w3-display-container w3-padding'>
                     ...
                     <div style ={{width:'33.3%'}} className = 'w3-button w3-display-middle'><FaRegComment size ={'25px'} /><br></br><span>1M</span></div>
                     <div style ={{width:'33.3%'}} className = 'w3-button w3-display-right'><FaShare size ={'25px'} /><br></br><span>200K</span></div>
              </div>
              <div>
                     <input hint='Enter Comment' type = 'text'/>
               </div>
        </div>
    </>
  );
