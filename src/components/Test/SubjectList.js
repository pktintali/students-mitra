...
//}
  ...
  return (
    <div className = 'w3-animate-left'> 
          ...
          <button onClick = {startQuiz} className = {`w3-hide-large w3-hide-medium w3-large w3-round w3-red w3-margin w3-button ${disabled} `}>Start</button>
                  <SubjectCard game = {props.game} enableButton = {enable} id = {props.id} subject = {sub}/>
                   <br/><br/>
  ...
  return (
<>
     <Questions1 sub = {props.s} host = {props.host} game = {props.game} click = {props.click} />
</>
);
}
  }
      ...
      return (
       ...
       {props.id===1&&  <Questions1 host = {props.host} game = {props.game} click = {props.click} /> }
